<section class="container-fluid p-0">
  <div class="d-flex align-items-stretch">
    <div id="userModel" class="col-12 col-sm-12 p-3">
      <div class="glass rounded shadow p-3">
        <div class="d-flex justify-content-between m-0">
          <h1><i class="<?= W::fa('users') ?>"></i> <?= _t('users') ?></h1>
          <div>
        ...
        <hr class="m-0 mb-3"/>
        <div class="row">
          <div id="userTable" class="col-sm-5">
            <!-- TABLA -->
          ...
          <div class="col-sm-7">
            <div data-bind="with: newItem" id="userForm"
              class="form-wrapper bg-dark text-light rounded p-3 shadow sticky-top">
              <h2 data-bind="visible: 'new'==collection.state()" class="pb-1">Crear Nueva Usuario</h2>
              <h2 data-bind="visible: 'edit'==collection.state()" class="pb-1">Modificar Usuario</h2>
              <!-- FORMULARIO -->
              <form data-bind="submit: Collection.dataSave" action="#" method="post">
                <div data-bind="foreach: {data: column_names, as: 'cn'}">
                  <div data-bind="with: $parent.columns()[cn]" class="row mb-md-2 g-2">
...
(function() {
  ...
  const CONTACT_MESSAGES = {
    create: 'Nuevo Usuario creado correctamente',
    update: 'Usuario modificada¡o correctamente',
    delete: 'Usuario eliminado correctamente',
    are_you_sure: '¿Quieres continuar para eliminar este Usuario?',
  }

  var collection = new Collection('/api/v1/users',{
    columns: CONTACT_COLUMNS,
    messages: CONTACT_MESSAGES,
  });
  $(function() {
    ko.applyBindings(collection, document.getElementById('userModel'))
  })
}).call(this)
</script>
<section class="container-fluid p-0">
  <div class="d-flex align-items-stretch">
    ...
    <div id="farmModel" class="col-12 col-sm-10 p-3">
      <div class="glass rounded shadow p-3">
        <div class="d-flex justify-content-between m-0">
          <h1><i class="<?= W::fa('farms') ?>"></i> <?= _t('farms') ?></h1>
          <div>
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div data-bind="with: newItem" id="farmForm"
              class="form-wrapper bg-dark text-light rounded p-3 shadow sticky-top">
              <h2 data-bind="visible: 'new'==collection.state()" class="pb-1">Crear Nueva Granja</h2>
              <h2 data-bind="visible: 'edit'==collection.state()" class="pb-1">Modificar Granja</h2>
              <!-- FORMULARIO -->
...
(function() {
  ...
  const PRODUCT_MESSAGES = {
    create: 'Nueva Granja creada correctamente',
    update: 'Granja modificada correctamente',
    delete: 'Granja eliminada correctamente',
    are_you_sure: '¿Quieres continuar para eliminar esta Granja?',
  }

  var collection = new Collection('/api/v1/farms',{
    columns: PRODUCT_COLUMNS,
    messages: PRODUCT_MESSAGES,
  });
  $(function() {
    ko.applyBindings(collection, document.getElementById('farmModel'))
  })
}).call(this)
</script>